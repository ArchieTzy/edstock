...
class RequestsController extends AppController
{
    ...
    {
        $requests = $this->Requests->find('all',['contain'=>['Offices', 'Fclusters', 'Departments']]);
    ...
    public function add()
    {
        ...
        $fclusters = $this->Requests->Fclusters->find('list', ['limit' => 200])->all();
        $departments = $this->Requests->Departments->find('list', ['limit' => 200])->all();
        $this->set(compact('request', 'offices', 'fclusters', 'departments'));
    }
