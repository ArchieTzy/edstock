            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?= $this->Form->control('fcluster_id',['class'=>'form-control', 'options'=>$fclusters,'label'=>false]) ?>
                        <label>Office/Section</label>
                        <?= $this->Form->control('department_id',['class'=>'form-control', 'options'=>$departments,'label'=>false]) ?>
                        <label>PR No.</label>
                        <?= $this->Form->control('pr_no',['class'=>'form-control','label'=>false,'required']) ?>
                        <label>Responsibility Center Code</label>
                        <?= $this->Form->control('responsibility_center_code',['class'=>'form-control','label'=>false, 'required' => false]) ?>
                        <label>Purpose</label>
