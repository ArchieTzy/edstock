...
<div class="requestdetails index content">
    <?= $this->Html->link(__('New Requestdetail'), ['action' => '/admin/add'], ['class' => 'button float-right']) ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $requestdetail->has('request') ? $this->Html->link($requestdetail->request->id, ['controller' => '/Admin/Requests', 'action' => 'view', $requestdetail->request->id]) : '' ?></td>
                    <td><?= $requestdetail->has('item') ? $this->Html->link($requestdetail->item->description, ['controller' => '/Admin/Items', 'action' => 'view', $requestdetail->item->id]) : '' ?></td>
